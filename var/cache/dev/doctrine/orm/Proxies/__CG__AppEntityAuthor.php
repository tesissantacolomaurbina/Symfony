...
class Author extends \App\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'lastname', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'books', '' . "\0" . 'App\\Entity\\Author' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function addUser(\App\Entity\User $user): \App\Entity\Author
    {
     ...
     * {@inheritDoc}
     */
    public function removeUser(\App\Entity\User $user): \App\Entity\Author
    {
