...
// Returns the private 'App\Repository\UserBookRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UserBookRepository.php';

return $this->privates['App\\Repository\\UserBookRepository'] = new \App\Repository\UserBookRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
